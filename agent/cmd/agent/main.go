// Package main is the entry point for the Infra Autopilot health agent.
//
...
import (
	...
	"github.com/ethan-k-francis/infra-autopilot/agent/internal/config"
	"github.com/ethan-k-francis/infra-autopilot/agent/internal/remediation"
	"github.com/ethan-k-francis/infra-autopilot/agent/internal/watcher"
	"github.com/ethan-k-francis/infra-autopilot/agent/internal/webhook"
)

func main() {
	log.SetFlags(log.Ldate | log.Ltime | log.Lmicroseconds | log.Lshortfile)
	log.Println("[main] starting infra-autopilot health agent")
